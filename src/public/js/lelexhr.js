...
const apiRequest = {
	get: (url, data, successCB, errorCB) => {
		return ajax(url, 'get', data, (data, status, xhr) => successCB && successCB(data.data, data.systemDate), errorCB);
	},
	post: (url, data, successCB, errorCB) => {
		return ajax(url, 'post', data, (data, status, xhr) => successCB && successCB(data.data, data.systemDate), errorCB);
	}
};
